...
var source = fs.readFileSync('./example.tot', 'utf8')
var syntax = esprima.parse(source)

// var syntax = esprima.parse('something(1, 2, 3, function(err, foo, bar) { next() })')
// console.log('syntax', JSON.stringify(syntax, null, 2))
